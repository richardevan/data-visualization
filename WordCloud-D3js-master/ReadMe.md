...
![ScreenShot](/Images/preprocessing1.png)
...
![ScreenShot](/Images/preprocessing2.png)    
...
![ScreenShot](/Images/indexing.png)
...
![ScreenShot](/Images/Screen Shot 2016-11-11 at 1.56.20 PM.png)
![ScreenShot](/Images/Screen Shot 2016-11-11 at 1.57.54 PM.png)
![ScreenShot](/Images/Screen Shot 2016-11-11 at 1.58.20 PM.png)
...
![ScreenShot](/Images/Force directed graph.PNG)

## Findings:

1. **Various Clusters Among Words Can Be Identified From The Relationship Graph** : The Force Directed graphs allows us to see patterns or clusters among words. These clusters can be used for 'Topic Analysis'![ScreenShot](/Images/corelation.PNG)
2. **Presidential Elections and Candidates Are Visible From the Stream Graph** : In this example, you can see how John McCain as well as Barack Obama were mentioned frequently during the election cycle ![ScreenShot](h/Images/Screen Shot 2016-11-11 at 2.40.36 PM.png) ![ScreenShot](/Images/Screen Shot 2016-11-11 at 2.41.14 PM.png)
